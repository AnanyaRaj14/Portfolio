      ...
      <div className='text-white mt-10'>
        ...
        <div className='flex items-center justify-around mt-10 text-center font-bold'>
          <div className='h-48 w-96 bg-red-600 '>
            ...
            href="https://github.com/AnanyaRaj14/react-todo">Click here</a>
          </div>
          <div className='h-48 w-96 bg-red-600 '>
            ...
            <a className='text-blue-700 underline' 
            href="https://github.com/AnanyaRaj14/react-password">Click here</a>
          </div>
          <div className='h-48 w-96 bg-red-600 '>
            ...
            <a className='text-blue-700 underline' 
            href="https://github.com/AnanyaRaj14/Theme-Switcher">Click here</a>
          </div>
        </div>
        ...
        <div className='flex items-center justify-around mt-10 text-center font-bold'>
          <div className='h-48 w-96 bg-red-600'>
            ...
            <a className='text-blue-700 underline' 
            href="https://github.com/AnanyaRaj14/Random_quotes_generator">Click here</a>
          </div>
          <div className='h-48 w-96 bg-red-600'>
            ...
            <a className='text-blue-700 underline' 
            href="https://github.com/AnanyaRaj14/Stopwatch">Click here</a>
          </div>
          <div className='h-48 w-96 bg-red-600'>
            ...
            <a className='text-blue-700 underline' 
            href="https://github.com/AnanyaRaj14/image_slider">Click here</a>
          </div>
        </div>
      </div>
    </>
